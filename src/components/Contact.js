    ...
    <div className='contact' id='Contact'>
      <div className='contact-left'>
        ...
        <div>
          ...
          <div className='contact-div'>
            <span className='contact-span-1'><FontAwesomeIcon icon={faLocationPin} style={{ color: '#FCA61F', fontSize: '20px', paddingRight: '1rem' }} /></span>
        ...
        <div>
          ...
          <div className='contact-div'>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <span><a href='https://github.com/atharvabhuse' style={{ textDecoration: 'none', color: '#0068CC' }}>View github profile</a></span>
            </div>
          </div>
        </div>
