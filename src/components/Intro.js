        ...
        <>
            ...
            <div className='intro-div' id='Intro'>
                <div className='intro-div-left' style={{ backgroundImage: `url(${background})`, animation: 'fadeIn 1s forwards', transform: 'rotateZ(30deg) !important' }}>
                    ...
                    <span>
                        <span><a href='https://github.com/atharvabhuse'><img className='github' src={github} /></a></span>

                        <span><a href='https://www.linkedin.com/in/atharva-bhuse/'><img className='linkedin' src={linkedin} /></a></span>
                    </span>
                </div>
                <div className='intro-div-right'>
                    ...
                    <motion.div initial={{ left: '-15%' }} whileInView={{ left: '0%' }} transition={{ duration: '2', type: 'spring' }} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.7 }} style={{ position: 'absolute', zIndex: 5, marginTop: '2rem', marginLeft: '0rem', cursor: 'pointer' }}>
                        <FloatingDiv className='FloatingDivblue' text1={"React"} text2={"Proficiency"} icon={cup} />
                    </motion.div>

                    <motion.div initial={{ left: '-15%' }} whileInView={{ left: '0%' }} transition={{ duration: '2', type: 'spring' }} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.7 }} style={{ position: 'absolute', zIndex: 5, marginTop: '22rem', marginLeft: '0rem', cursor: 'pointer' }}>
            ...
            {popup ? <Popup click={overlayClickHandler} style={{ backgroundColor: colorChange ? color : '' }} /> : ""}
